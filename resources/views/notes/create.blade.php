...
<div class="max-w-xl mx-auto py-8">
    <h1 class="text-2xl font-bold mb-6">Create Note</h1>
    <form action="{{ route('notes.store') }}" method="POST" class="bg-white shadow rounded p-6 space-y-4">
        @csrf
        <div>
        ...
        <div>
            ...
            <textarea name="content" rows="5" class="w-full border rounded px-3 py-2" required>{{ old('content') }}</textarea>
